...
见`org.zetaframework.websocket.WebsocketStompConfiguration`。注释已经完善了，看注释就行
...
/** 业务包 */
// 聊天室
com.zeta.admin.controller.msg.ChartController

/** zetaframework包 */
// Websocket配置
org.zetaframework.websocket.WebsocketStompConfiguration
// Websocket用户消息 拦截器
org.zetaframework.websocket.interceptor.WsUserInterceptor
```
