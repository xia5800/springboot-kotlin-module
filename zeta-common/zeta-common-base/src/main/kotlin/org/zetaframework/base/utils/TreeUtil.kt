package org.zetaframework.base.utils
...
object TreeUtil {
     ...
     * @return List<E>
     */
    fun <E: org.zetaframework.base.entity.ITree<E, out Serializable>> buildTree(list: MutableList<E>, isShowNullChildren: Boolean = true): List<E> {
