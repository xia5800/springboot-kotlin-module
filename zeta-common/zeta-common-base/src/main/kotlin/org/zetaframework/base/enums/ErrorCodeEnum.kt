package org.zetaframework.base.enums
...
enum class ErrorCodeEnum(val code: Int, val msg: String) {
    ...
    /***************************通用错误******************************/
    /** 通用操作成功 */
    OK(ApiResult.SUCCESS_CODE, ApiResult.SUCCESS_MSG),
    /** 通用操作失败 */
    ERROR(ApiResult.FAIL_CODE, ApiResult.FAIL_MSG),
    /** 操作失败 */
    FAIL(ApiResult.FAIL_CODE, ApiResult.FAIL_MSG),
    /** 操作成功 */
    SUCCESS(ApiResult.SUCCESS_CODE, ApiResult.SUCCESS_MSG),
    /** 系统繁忙 */
