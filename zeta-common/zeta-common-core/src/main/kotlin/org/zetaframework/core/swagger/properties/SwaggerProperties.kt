...
class SwaggerProperties(
    ...
    data class DocketInfo (
        ...
        fun getTitleOrDefault(default: String): String? =
            if (this.title == null) { default } else { this.title }

        fun getDescriptionOrDefault(default: String): String? =
            if (this.description == null) { default } else { this.description }
    }
}
