package org.zetaframework.satoken.aspect
...
import org.zetaframework.annotation.satoken.PreCheckRole
...
class PreCheckAspect(private val ignoreProperties: IgnoreProperties) {
    companion object {
        ...
        const val POINTCUT_SIGN: String =
            "@within(org.zetaframework.annotation.satoken.PreCheckPermission) || " +
                    "@annotation(org.zetaframework.annotation.satoken.PreCheckPermission) || " +
                    "@within(org.zetaframework.annotation.satoken.PreCheckRole) || " +
                    "@annotation(org.zetaframework.annotation.satoken.PreCheckRole)"
    }
